...
from cityscapesscripts.helpers.labels     import name2label as name2label_orig
from cityscapesscripts.helpers.labels_s2v     import name2label as name2label_s2v
...
def json2labelImg(inJson, outImg, encoding="ids", classes=''):
    annotation = Annotation()
    annotation.fromJsonFile(inJson)
    labelImg   = createLabelImage( annotation , encoding, classes )
